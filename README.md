...
**NOTE:** The results for BERT, ChatGPT4, Llama2-7B, and CodeLlama-7B presented here are from our paper, where CodeLlama-7B was the best-performing model. The results for Qwen2.5-Coder-1.5B and Qwen2.5-Coder-7B are from our newly trained models, which are based on [Qwen2.5-Coder](https://github.com/QwenLM/Qwen2.5-Coder) and were trained and tested on the same [dataset](https://huggingface.co/datasets/0x404/ccs_dataset).

| Metrics            | BERT       | ChatGPT4   | Llama2-7B     | CodeLlama-7B | Qwen2.5-Coder-1.5B |Qwen2.5-Coder-7B |
|:-------------------|:-----------:|:-----------:|:-----------:|:------------:|:------------:|:------------:|
| build_precision    | 0.6304     | **0.8286** | 0.6905     | 0.7442      |0.7273      |0.7955      |
| build_recall       | 0.725      | 0.725      | 0.725      | 0.8         |0.8         |**0.875**   |
| build_f1           | 0.6744     | **0.7733** | 0.7073     | 0.7711      |0.7619      |0.8333      |
| ci_precision       | **0.8718** | 0.8571     | 0.8409     | 0.8605      |0.8222      |0.8605      |
| ci_recall          | 0.85       | 0.9        | **0.925**  | 0.925       |0.925       |0.925       |
| ci_f1              | 0.8608     | 0.878      | 0.881      | 0.8916      |0.8706      |**0.8917**  |
| docs_precision     | 0.8095     | 0.8974     | 0.7451     | 0.8372      |0.8666      |**0.9487**  |
| docs_recall        | 0.85       | 0.875      | 0.95       | 0.9         |**0.975**   |0.925       |
| docs_f1            | 0.8293     | 0.8861     | 0.8352     | 0.8675      |0.9176      |**0.9367**  |
| perf_precision     | 0.3939     | **0.9545** | 0.875      | 0.8378      |0.7907      |0.9143      |
| perf_recall        | 0.65       | 0.525      | 0.7        | 0.775       |**0.85**    |0.8         |
| perf_f1            | 0.4906     | 0.6774     | 0.7778     | 0.8052      |0.8192      |**0.8533**  |
| chore_precision    | 0.3846     | 0.6957     | 0.6129     | 0.7391      |**0.8235**  |0.6875      |
| chore_recall       | 0.5        | 0.4        | 0.475      | 0.425       |0.35        |**0.55**    |
| chore_f1           | 0.4348     | 0.5079     | 0.5352     | 0.5397      |0.4912      |**0.6111**  |
| test_precision     | 0.6923     | 0.9        | 0.8889     | **0.9459**  |0.7959      |0.8636      |
| test_recall        | 0.675      | 0.675      | 0.8        | 0.875       |0.975       |**0.95**    |
| test_f1            | 0.6835     | 0.7714     | 0.8421     | **0.9091**  |0.8764      |0.9048      |
| fix_precision      | 0.4167     | 0.4808     | 0.6829     | 0.6667      |**0.6875**  |**0.6875**  |
| fix_recall         | 0.25       | 0.625      | 0.7        | 0.7         |**0.825**   |**0.825**   |
| fix_f1             | 0.3125     | 0.5435     | 0.6914     | 0.6829      |**0.75**    |**0.75**    |
| refactor_precision | 0.2414     | 0.4545     | 0.5814     | 0.5085      |0.76        |**0.7742**  |
| refactor_recall    | 0.175      | 0.625      | 0.625      | **0.75**    |0.475       |0.6         |
| refactor_f1        | 0.2029     | 0.5263     | 0.6024     | 0.6061      |0.5846      |**0.6761**  |
| style_precision    | 0.5333     | **0.8966** | 0.8049     | 0.7805      |0.8333      |0.7805      |
| style_recall       | 0.2        | 0.65       | **0.825**  | 0.8         |0.75        |0.8         |
| style_f1           | 0.2909     | 0.7536     | **0.8148** | 0.7901      |0.7895      |0.7901      |
| feat_precision     | 0.4583     | 0.5205     | 0.8205     | **0.875**   |0.7917      |0.8605      |
| feat_recall        | 0.55       | **0.95**   | 0.8        | 0.7         |**0.95**    |0.925       |
| feat_f1            | 0.5        | 0.6726     | 0.8101     | 0.7778      |0.8636      |**0.8916**  |
| macro_precision    | 0.5432     | 0.7486     | 0.7543     | 0.7795      |0.7899      |**0.8173**  |
| macro_recall       | 0.5425     | 0.695      | 0.7525     | 0.765       |0.7875      |**0.8175**  |
| macro_f1           | 0.528      | 0.699      | 0.7497     | 0.7641      |0.7725      |**0.8139**  |
| accuracy           | 0.5425     | 0.695      | 0.7525     | 0.765       |0.7875      |**0.8175**  |
